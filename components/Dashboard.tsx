    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 animate-fadeIn">
      ...
      <div className="relative z-10 px-8 py-8 max-w-7xl mx-auto space-y-8">
        ...
        <div data-tour="stats" className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-5 border border-slate-200 dark:border-slate-700">
            <div className="w-8 h-8 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center mb-3">
              ...
              {filteredSessions.map((session) => {
                ...
                return (
                  <div
                    ...
                    className={`group bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-200 flex flex-col ${deletingSession === session.id ? 'animate-disappear' : ''}`}
